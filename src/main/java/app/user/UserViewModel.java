...
public class UserViewModel implements ViewModel
{
    ...
    private final PlayersViewModel players;
    private final CharactersViewModel characters;

    public UserViewModel(UserContext user) {
        this.players = new PlayersViewModel(user);
        this.characters = new CharactersViewModel(user);
        this.user = user;
